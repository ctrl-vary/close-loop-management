  ...
  <div class="app-container">
          ...
          <template slot-scope="scope">
            ...
            >
              <div v-if="dictitem.dictionaryItemValue">
                <el-switch
                  v-model="dictitem.status"
                  @change="btnSwitchEvent(dictitem)"
                  active-color="#13ce66"
                ...
                {{ dictitem.dictionaryItemValue }}
                <el-button
                  size="mini"
                  type="text"
                  icon="el-icon-delete"
                  @click="
                    btnDeleteDicts(dictitem.id, dictitem.dictionaryItemValue)
                  "
                ></el-button>
              </div>
            </div>
    ...
    >
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="btnAddDictionaryItem"
          >确 定</el-button
        >
      </span>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    btnAddNewCodeItem(rowDictInfo) {
      this.addNewCodeItemForm.dictionaryTypeName =
        rowDictInfo.dictionaryTypeName;
