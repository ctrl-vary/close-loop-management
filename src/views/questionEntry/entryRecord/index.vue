  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          icon="el-icon-edit"
          size="mini"
          :disabled="this.selectArr.length === 1 ? false : true"
          @click="questionEditDialogVisible = true"
          >修改
        </el-button>
      </el-col>
      <!-- <el-col :span="1.5">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          :disabled="this.selectArr.length > 0 ? false : true"
          @click="btnBatchPost"
          >批量提交</el-button
        >
      </el-col>
      ...
      <div class="top-right-btn">
        <el-col :span="1.5" style="margin-right: 15px">
          <el-badge
            type="primary"
            :value="nowQuestionNum"
            :hidden="nowQuestionNum == 0"
          >
            <el-button
              type="primary"
              plain
              size="mini"
              @click="btnChangeTable('ques')"
            >
              {{ allTableTitle.quesName }}
            </el-button>
          </el-badge>
        </el-col>
        ...
        <el-col :span="1.5" style="margin-right: 15px">
          <el-badge
            type="success"
            :value="hadCloseNum"
            :hidden="hadCloseNum == 0"
          >
            <el-button
              type="success"
              plain
              size="mini"
              @click="btnChangeTable('hadclose')"
            >
              {{ allTableTitle.hadClose }}
            </el-button>
          </el-badge>
        </el-col>
        ...
        <el-col :span="1.5">
          ...
          >
            <el-button
              size="mini"
              type="info"
              @click="btnChangeTable('noclose')"
            >
              {{ allTableTitle.noClose }}
            </el-button>
          </el-badge>
        </el-col>
      </div>
    ...
    >
      <template slot="allSelect">
        <el-table-column
          :type="nowColName == 'ques' ? 'selection' : ''"
          width="60"
        ></el-table-column>
      </template>
        ...
        <el-table-column label="操作" align="center" min-width="140">
          <template slot-scope="scope">
            ...
            <el-button
              ...
              icon="el-icon-delete"
              size="mini"
              @click="btnDelete(scope.row.quesId)"
              >删除
            </el-button>
            <el-button
              type="text"
    ...
    <!-- Excel文件暂时 -->
    <el-row
      class="all-center all-margin-top-15"
      v-if="this.excelTable.length > 0"
    >
      <h4>Excel导入文件预览</h4>
      <div>
        <el-button
    ...
    >
      <el-tabs v-model="activeName" type="card">
        ...
        <el-tab-pane label="批量录入" name="second" class="all-center">
          <batchadd-form
            @updateList="getAlltempQuesList"
            :postExcelTable.sync="excelTable"
            :fatherDialogVisible.sync="questionAddDialogVisible"
          >
          </batchadd-form>
        </el-tab-pane>
    ...
    <el-dialog
      title="问题修改"
      :visible.sync="questionEditDialogVisible"
      width="50%"
    >
      <el-form label-width="130px">
        ...
        <el-form-item label="预计整改完成时间:">
          <el-date-picker
            v-model="tempEditForm.planEndTime"
            type="date"
            placeholder="选择日期"
          >
          </el-date-picker>
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="questionEditDialogVisible = false"
          >取 消</el-button
        >
        <el-button size="mini" type="primary" @click="btnConfirmEdit"
          >确定修改</el-button
        >
      </span>
    </el-dialog>
